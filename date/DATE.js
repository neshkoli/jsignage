 ...
 * It is strictly forbidden to use or  reproduce all or parts of this      
 * program without author's explicit   permission.                         
 * Commercial use of this program is   subject to purchase. Please contact 
 * the author.                         
 * abstract class JDate
 * JDate is the base class for GDate and HDate.
 * Do not instanciate JDate.
 * usage :
 * GD = new GDate(17,7,1984)
 * HD = new HDate(GD) */
function JDate(){
	...
	this.nbMonth = null;
	/*protected pure virtual methods * Subclasses must implement.	 * Do not call these methods outside the class hierarchy.*/
	this.calculate = null;
	this.setDate_int_int_int = null;
	/* protected attributes Do not access (read/write) these attributes outside the class hierarchy.*/
	this.m_hdn = 0;
	this.m_day = 0;
	this.m_month = 0;
	this.m_year = 0;
	...
	function setDate_int(hdn){		this.setHdn(hdn);		return this;	}
	function setDate_JDate(jdate){	return this.setDate_int(jdate.m_hdn);}
	...
	function nextDay()	/* Add 1 day : method optimized within same month. */	{
...
function GDate(){
	...
	/* public methods */
	function isLeap(){	return GDate.isLeapYear(this.m_year);	}
	function getMonthLength(){	return st_monthLength(this.m_month, this.m_year);	}
	function getYearLength()	{		return this.isLeap() ? 366 : 365;	}
	function today()	{		var d = new Date();	this.setDate_int_int_int(d.getDate(), d.getMonth() + 1, d.getFullYear());}
	function nbMonths()	{		return 12;	}
	/** protected overrides */
...
HDate.isEmbolismic = function(year){return (((12 * parseInt(year) + 17) % 19) >= 12);};
function HDate(){
	/* runtime class info */
	this.Class = HDate;
	/* public methods*/
	...
	/***** * Implementation ******/
	/*	 * private class methods.	 */
	function st_embolismicYear(year)	{	return (((12 * parseInt(year) + 17) % 19) >= 12);}
...
//		return ["","Nisan","Iyar","Sivan","Tamuz","Av","Elul","Tishri","Cheshvan","Kislev","Tevet","Shvat","Adar","Adar a","Adar b"]
		return ["","ניסן","אייר","סיוון","תמוז","אב","אלול","תשרי","חשוון","כסלו","טבת","שבט","אדר","אדר א","אדר ב"]
		[this.getMonth()] ;
	}
	function getHebNumber(){
//		return ["","Nisan","Iyar","Sivan","Tamuz","Av","Elul","Tishri","Cheshvan","Kislev","Tevet","Shvat","Adar","Adar a","Adar b"]
		return ["","א","ב","ג","ד","ה","ו","ז","ח","ט","י","יא","יב","יג","יד","טו","טז","יז","יח","יט","כ","כא","כב","כג","כד","כה","כו","כז","כח","כט","ל"];
	}
	function calculate(){
		var jdn;
		var days;
